...
def test_course_details():
    ...
    ECE444_expected = {
        ...
        "description": "The software development process. Software requirements and specifications. Software design techniques. Techniques for developing large software systems; CASE tools and software development environments. Software testing, documentation and maintenance.",
        "prereq": "['ECE344H1', 'ECE353H1']",
        "level": 4,
        "campus": "St. George",
        "term": "['2021 Fall']",
        "coreq": "[]",
...
# Written by Markus Kunej
def test_about():
    """Test successful response code for about request"""
    tester = app.test_client()
